...
export default function ConfirmTransaction() {
    ...
    useEffect(() => {
        const fetchFee = async () => {
            //let f = await transactionFeeDOGE(state.newTransaction.network)
        ...
        <PageContent title="Confirm new transaction">
            <form onSubmit={e => validateAndExecute(e)}>
                ...
                <RowItemSingle>
                    ...
                    <div className="float-left font-bold">0.0025 {state.newTransaction.coinSymbol} ({fee.comUsd.toLocaleString('en-US')} USD)</div>
                </RowItemSingle>
                <RowItemCustom>
