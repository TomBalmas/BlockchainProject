...
const walletReducer = require('./walletReducer');
const ethUtil = require('ethereumjs-util')
const walletBTC = require('./walletBTC')
const walletDOGE = require('./walletDOGE')
...
export const createNewWallet = () => {
    ...
    // var asdf = ethers.Wallet.fromMnemonic(walletReducer.seed.mnemonic);
    // console.log("wallet: " + asdf);
    // return asdf;
}
